...
unsigned int NTupleMaker::AddElectrons(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	...
	for(unsigned i = 0 ; i < Electrons->size() ; i++){
	  ...
	  if ((*Electrons)[i].pt()<cElPtMin) continue;
	  if (fabs((*Electrons)[i].eta())>cElEtaMax) continue;

	  electron_px[electron_count] = (*Electrons)[i].px();
	  electron_py[electron_count] = (*Electrons)[i].py();
	  electron_pz[electron_count] = (*Electrons)[i].pz();
	  electron_pt[electron_count] = (*Electrons)[i].pt();
	  electron_eta[electron_count] = (*Electrons)[i].eta();
	  ...
	  electron_deltaetasuperclustertrack[electron_count] = (*Electrons)[i].deltaEtaSuperClusterTrackAtVtx();
	  electron_deltaphisuperclustertrack[electron_count] = (*Electrons)[i].deltaEtaSuperClusterTrackAtVtx();
	  electron_e1x5[electron_count] = (*Electrons)[i].e1x5();
	  electron_e2x5[electron_count] = (*Electrons)[i].e2x5Max();
	  electron_e5x5[electron_count] = (*Electrons)[i].e5x5();
	  electron_sigmaetaeta[electron_count] = (*Electrons)[i].sigmaEtaEta();
	  electron_sigmaietaieta[electron_count] = (*Electrons)[i].sigmaIetaIeta();
	  electron_full5x5_sigmaietaieta[electron_count] = (*Electrons)[i].full5x5_sigmaIetaIeta();
	  electron_ehcaloverecal[electron_count] = (*Electrons)[i].hcalOverEcal();
	  electron_ehcaloverecaldepth1[electron_count] = (*Electrons)[i].hcalDepth1OverEcal();
	  electron_ehcaloverecaldepth2[electron_count] = (*Electrons)[i].hcalDepth2OverEcal();
	  electron_info[electron_count] = 0;
	  electron_info[electron_count] |= (*Electrons)[i].isElectron(); 
	  electron_ooemoop[electron_count] = (1.0/(*Electrons)[i].ecalEnergy() - (*Electrons)[i].eSuperClusterOverP()/(*Electrons)[i].ecalEnergy());
	  
	  electron_superClusterEta[electron_count] = (*Electrons)[i].superCluster()->eta();
	  electron_superClusterPhi[electron_count] = (*Electrons)[i].superCluster()->phi();
	  electron_superClusterX[electron_count] = (*Electrons)[i].superCluster()->x();
	  electron_superClusterY[electron_count] = (*Electrons)[i].superCluster()->y();
	  electron_superClusterZ[electron_count] = (*Electrons)[i].superCluster()->z();

	  electron_chargedHadIso[electron_count] = (*Electrons)[i].chargedHadronIso();
	  ...
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEE() << 1;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEBGap() << 2;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEBEtaGap() << 3;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEBPhiGap() << 4;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEEGap() << 5;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEERingGap() << 6;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEEDeeGap() << 7;
	  electron_gapinfo[electron_count] |= (*Electrons)[i].isEBEEGap() << 8;
	  
	  electron_chargeinfo[electron_count] = 0;
	  if((*Electrons)[i].isGsfCtfChargeConsistent()) electron_chargeinfo[electron_count] |= (1 << 0);
	  if((*Electrons)[i].isGsfCtfScPixChargeConsistent()) electron_chargeinfo[electron_count] |= (1 << 1);
	  if((*Electrons)[i].isGsfScPixChargeConsistent()) electron_chargeinfo[electron_count] |= (1 << 2);
	  
	  electron_fbrems[electron_count] = (*Electrons)[i].fbrem();
	  electron_numbrems[electron_count] = (*Electrons)[i].numberOfBrems();
